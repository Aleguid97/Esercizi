...
const addTask = function () {
  ...
  let newTask = `
      <div class="task">
          <span id="taskname" style='border: solid black 1px; padding-right: 3em;
          padding-left:3em; padding-top:5px; padding-bottom:5px; margin-right:10px;
          background-color:rgb(201, 233, 233);border-radius: 5px;'>
              ${inputField.value}
          </span>
          <button class="delete">
